...
public interface Deque<E> {
	...
	/**
	 * Retrieves, but does not remove, the head of the deque (the first element of this deque)
	 * or returns null if this deque is empty.
	 * @return the head of the deque or null if this deque is empty
	 */
	E peek();
	/**
	 * Retrieves and removes, the head of the deque (the first element of this deque)
	 * or returns null if this deque is empty.
	 * @return the head of the deque or null if this deque is empty
	 */
	E poll();
	/**
	 * Retrieves, but does not remove, the final element of the deque (the last element of this deque)
	 * or returns null if this deque is empty.

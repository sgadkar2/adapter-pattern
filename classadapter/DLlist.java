...
public class DLlist<E> {
	...
	/**
	 * Inserts the specified element at the specified index position in this doubly-linked list.
	 * If the index is list.length(), then the insertion is at the end of the doubly-linked list.
	...
	/**
	 * Deletes the element at the specified index position in this doubly-linked list. 
	...
	/**
	 * Deletes the first occurrence of the specified element from this doubly-linked list, if it is present.
	 * Returns false if the doubly-linked list is empty.
	 * @param e element to be deleted from this doubly-linked list if present
	 * @return true if this doubly-linked list contained the specified element, otherwise false
	 */
